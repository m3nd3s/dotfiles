...
require("m3nd3s.config.coq") -- Inicializa o COQ v2
...
local ruby_lsp_config = {
  name = "ruby_lsp",
  cmd = { "/home/ALMIR.MENDES/.asdf/shims/ruby-lsp" },
...
local js_lsp_config = {
  name = "vtsls",
  cmd = { "/home/ALMIR.MENDES/.asdf/shims/vtsls", "--stdio" },
...
local yaml_lsp_config = {
  name = "yamlls",
  cmd = { "/home/ALMIR.MENDES/.asdf/shims/yaml-language-server", "--stdio" },
...
local emmet_lsp_config = {
  name = "emmet_ls",
  cmd = { "/home/ALMIR.MENDES/.asdf/shims/emmet-language-server", "--stdio" },
